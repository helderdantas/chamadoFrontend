...
class ColecaoChamado {
    async criarChamado(chamado) {
        try {
            ...
            var response = await axios.post(`${"http://10.0.0.129:3032/"}criarChamado/`, body);
    ...
    async atualizarChamado(chamado) {
        try {
            try {
                let config = {
                    method: "put",
                    url: `${"http://10.0.0.129:3032/"}updateChamado/` + chamado.id,
                    data: {
                        subSetor: chamado.subSetor,
                        equipamentoComDefeito: chamado.equipamentoComDefeito,
                        equipeSuport: chamado.equipeSuport,
    ...
    async finalizarChamado(chamado) {
        try {
            if (chamado.id) {
                let config = {
                    method: "put",
                    url: `${"http://10.0.0.129:3032/"}updateCampoAbertoChamado/` + chamado.id,
                    headers: {}
                };
                await axios(config);
    ...
    async obterChamadosAbertos() {
        try {
            let response = await axios.get(`${"http://10.0.0.129:3032/"}listarChamadosAbertos`);
    ...
    async obterChamadosComStatusAberto() {
        try {
            let response = await axios.get(`${"http://10.0.0.129:3032/"}listarChamadosComStatusAberto`);
            return response.data;
        } catch (error) {
            return error;
        }
    ...
    async obterTodosChamados() {
        ...
        try {
            let response = await axios.get(`${"http://10.0.0.129:3032/"}listarTodosChamados`);
            return response.data;
        } catch (error) {
            return error;
        }
    ...
    async chamadosPorSetor(nome, dataInicial, dataFinal) {
        try {
            ...
            const response = await axios.post(`${"http://10.0.0.129:3032/"}chamadosPorSetor`, body);
            return response.data;
        } catch (error) {
            return error;
        }
    ...
    async chamadosPorSuport(nome, dataInicial, dataFinal) {
        try {
            ...
            const response = await axios.post(`${"http://10.0.0.129:3032/"}chamadosPorSuport`, body);
            return response.data;
        } catch (error) {
            return error;
        }
    ...
    async chamadosPorTipoEquipamento(nome, dataInicial, dataFinal) {
        try {
            ...
            const response = await axios.post(`${"http://10.0.0.129:3032/"}chamadosPorTipoEquipamento`, body);
            return response.data;
        } catch (error) {
            return error;
        }
