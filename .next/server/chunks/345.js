...
/* harmony export */   "Z": () => (/* binding */ ColecaoControle)
/* harmony export */ });
const axios = __webpack_require__(2167);
class ColecaoControle {
    async obterControleControlePorId(id) {
        try {
            let response = await axios.get(`${"http://10.0.0.129:3030/"}listarControle/` + id);
...
// EXTERNAL MODULE: ./src/backend/db/ColecaoControle.ts
var ColecaoControle = __webpack_require__(7501);
// EXTERNAL MODULE: ./src/core/controle/Controle.ts
var Controle = __webpack_require__(2316);
...
function Formulario(props) {
    ...
    const repo = new ColecaoControle/* default */.Z();
    ...
    const { 0: controle1 , 1: setControle  } = (0,external_react_.useState)(Controle/* default.vazio */.Z.vazio());
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            !props.parametro && !id ? /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(Entrada/* default */.Z, {
                        texto: "C\xd3DIGO",
                        valor: qrcode,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Z": () => (/* binding */ Controle)
/* harmony export */ });
class Controle {
    #id;
    #setor;
